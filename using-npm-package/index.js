...
////////////////////////////////////////////////////////////////////////////
// Test thử với module slugify
const text = slugify('Coding Everyday', { lower: true })
console.log(text)

// Tạo 1 mảng slug từ dataObj
let arrSlug = dataObj.map(ele => slugify(ele.productName, { lower: true }))
console.log(arrSlug)
////////////////////////////////////////////////////////////////////////////
